...
function Sidebar() {
  ...
  const handleIconClick = (e, pageName?:string) => {
    // Get the clicked icon
    const clickedIcon = e.currentTarget;
    
    // Remove active class from all icons
    const allIcons = document.querySelectorAll('.mainIcons');
  ...
  return (
    <div className='Sidebar'>
      <div className='sidebar-top'>
        ...
        <div className='mainIcons active' onClick={(e)=>handleIconClick(e,"/")}>
          <svg xmlns="http://www.w3.org/2000/svg" className="adjustingColor" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <div className='mainIcons' onClick={(e)=>handleIconClick(e,"/data")}>
        ...
        <div className='mainIcons' onClick={(e)=>handleIconClick(e, "/users")}>
          <svg xmlns="http://www.w3.org/2000/svg" className="mainIcons" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <div className='mainIcons' onClick={(e)=>handleIconClick(e,"/catalog")}>
          <svg xmlns="http://www.w3.org/2000/svg"  className="mainIcons" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <div className='mainIcons' onClick={(e)=>handleIconClick(e, "/payments")}>
          <svg xmlns="http://www.w3.org/2000/svg" className="mainIcons" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <div className='mainIcons' onClick={(e)=>handleIconClick(e, "/info")}>
          <svg xmlns="http://www.w3.org/2000/svg" className="mainIcons" width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      <div className='sidebar-bottom'>
        ...
        <div className='mainIcons' onClick={(e)=>handleIconClick(e, "/settings")}>
          <svg xmlns="http://www.w3.org/2000/svg" className="mainIcons" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <div className='mainIcons' onClick={(e)=>handleIconClick(e, "/logout")}>
          <svg xmlns="http://www.w3.org/2000/svg" className="mainIcons" width="24" height="24" viewBox="0 0 24 24" fill="none">
