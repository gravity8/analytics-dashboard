...
function Sidebar() {
  ...
  const setActive = (e) => {
    // Get the parent element with class 'mainIcons'
    const clickedIcon = e.currentTarget.closest('.mainIcons');
    
    // Get all icons
    const allTabIcons = document.querySelectorAll('.mainIcons');
    
    // Remove active class from all icons
    allTabIcons.forEach(icon => {
  ...
  return (
    <div className='Sidebar'>
      <div className='sidebar-top'>
        ...
        <div className='mainIcons active' onClick={(e)=>setActive(e)}>
        ...
        <div className='mainIcons' onClick={(e)=>setActive(e)}>
      ...
      <div className='sidebar-bottom'>
        <div className='mainIcons' onClick={setActive}>
          <svg xmlns="http://www.w3.org/2000/svg" className="mainIcons" width="24" height="24" viewBox="0 0 24 24" fill="none">
